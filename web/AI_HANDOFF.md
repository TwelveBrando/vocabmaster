...
- Profile has a `Загрузить AI-контекст` action for preloading the whole personal vocabulary and a prepared/total counter. The prepared count includes personal words with a current AI context in local cache.
