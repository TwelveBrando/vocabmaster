...
export const Header: React.FC<HeaderProps> = ({
  currentView, onNavigate, onOpenSettings, vocabCount, cloudUser, onOpenAuth, onSignOut,
}) => {
      ...
      <div className="mx-auto flex max-w-[1540px] items-center justify-between gap-3">
        ...
        <div className="flex shrink-0 items-center gap-2" style={noDrag}>
          {cloudUser ? (
            ...
            <button type="button" onClick={onOpenAuth} className="hidden rounded-full border border-white/15 bg-white/[0.08] px-3.5 py-2 text-xs font-medium text-white/80 transition hover:bg-white hover:text-black sm:block">Войти</button>
          )}
