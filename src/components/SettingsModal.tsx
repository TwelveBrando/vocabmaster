...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-6 animate-fadeIn">
      ...
      {/* Modal Surface */}
      <div className={`settings-modal-panel relative w-full max-w-4xl rounded-2xl sm:rounded-3xl border shadow-2xl overflow-hidden flex flex-col max-h-[90vh] transition-all z-10 ${currentThemeConfig.modalBg} ${currentThemeConfig.cardBorder}`}>
        {/* Header */}
        <div className={`flex items-center justify-between gap-3 px-4 py-4 sm:px-8 sm:py-5 border-b ${currentThemeConfig.modalHeaderBg} ${currentThemeConfig.cardBorder}`}>
          <div className="flex min-w-0 items-center gap-3.5">
            <div className={`hidden sm:flex w-11 h-11 rounded-2xl items-center justify-center font-bold shadow-sm shrink-0 ${
            ...
            <div className="min-w-0">
              <h3 className={`text-base sm:text-xl font-extrabold tracking-tight ${currentThemeConfig.textPrimary}`}>
                <span className="sm:hidden">Настройки</span><span className="hidden sm:inline">Оформление & Настройки генерации и перевода</span>
              </h3>
              <p className={`hidden text-xs sm:block sm:text-sm mt-0.5 ${currentThemeConfig.textSecondary}`}>
          ...
          <button
            type="button"
            onClick={onClose}
            className={`w-10 h-10 shrink-0 rounded-xl flex items-center justify-center transition-all cursor-pointer ${
        ...
        {/* Content Body */}
        <div className="flex flex-1 flex-col gap-6 overflow-y-auto p-4 sm:gap-8 sm:p-8">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2 p-4 sm:p-5 rounded-2xl border bg-black/5 dark:bg-white/[0.03] border-current/10">
              ...
              <div className="flex flex-col items-start justify-between gap-1 text-[11px] mt-1 sm:flex-row sm:items-center">
          ...
          <div className="flex flex-col gap-4 pt-4 border-t border-slate-200/50 dark:border-white/10">
            ...
            <div className="flex items-center justify-between gap-4 p-4 rounded-2xl border bg-black/5 dark:bg-white/[0.03] border-current/10">
              <div className="min-w-0">
                <div className={`text-sm font-bold ${currentThemeConfig.textPrimary}`}>Автопереход при правильном ответе</div>
                <div className={`text-xs ${currentThemeConfig.textSecondary}`}>Переходить дальше без дополнительного подтверждения</div>
              </div>
              <input
                type="checkbox"
          ...
          <div className="flex flex-col items-stretch justify-between gap-3 p-4 sm:flex-row sm:items-center sm:p-4.5 rounded-2xl border bg-black/5 dark:bg-white/[0.03] border-current/10">
            <div className="min-w-0">
            ...
            <button
              ...
              className="flex min-h-11 items-center justify-center gap-2 rounded-xl border border-rose-500/30 px-4 py-2 text-xs font-bold text-rose-500 transition-all cursor-pointer hover:bg-rose-500/10"
            >
        ...
        {/* Footer */}
        <div className={`flex items-center justify-between gap-2 border-t px-4 py-3 sm:gap-4 sm:px-8 sm:py-4.5 ${currentThemeConfig.modalFooterBg} ${currentThemeConfig.cardBorder}`}>
          <button
            type="button"
            onClick={onClose}
            className={`min-h-11 min-w-0 flex-1 px-3 py-2.5 sm:flex-none sm:px-5 rounded-xl border text-xs font-bold cursor-pointer transition-all ${
              currentThemeConfig.isLight
          ...
          <FlowButton
            onClick={handleSave}
            className={`settings-save-button min-h-11 min-w-0 flex-1 whitespace-nowrap rounded-2xl px-3 py-3 font-bold text-xs shadow-xl transition-all sm:h-12 sm:w-[220px] sm:flex-none sm:px-7 sm:text-sm ${currentThemeConfig.primaryButton}`}
